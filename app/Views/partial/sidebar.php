    ...
    <aside class="bg-white w-60 h-full">
        <nav class="p-6">
            <ul class="flex flex-col space-y-0.5">
                ...
                <li class="px-4 py-2 rounded-lg hover:bg-gray-200 hover:text-slate-900 <?= ($url->getSegment(1) == 'product') || ($url->getSegment(1) == 'categories') ? 'active' : 'text-slate-950'; ?> transition duration-200">
